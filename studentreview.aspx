<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentreview.aspx.cs" Inherits="studentreview" %>
...
<body style="background-image: url('grad2.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
    <form id="form1" runat="server">   
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGeneratedColumns="False" Height="306px" style="margin-left: 400px; border: inset; margin-top: 69px" BackColor="DimGray" Width="550px">
            <EmptyDataTemplate>
